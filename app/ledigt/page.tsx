...
export default function ListingsPage() {
  ...
  const availableListings = listingsData.listings.filter(listing => listing.status === 'available')
                  ...
                  <article key={listing.id} className="rental-card">
                    <div className={styles.listingCardGrid}>
                      ...
                      <div>
                        ...
                        <p style={{ margin: '0 0 1rem 0' }}>{listing.basic.shortDescription}</p>
        ...
        <aside>
          ...
          {primaryAgent && (
            <article>
              ...
              >
                ...
                />
                <div>
                  <h5 style={{ margin: 0 }}>{primaryAgent.personal.fullName}</h5>
                </div>
              </div>

              <p style={{ fontSize: '0.9rem', margin: '1rem 0' }}>{primaryAgent.personal.bio}</p>
          ...
          {primaryAgent && (
            <article>
              ...
              <dl>
                ...
                <dd>
                  <a href={`tel:${primaryAgent.personal.phone}`}>{primaryAgent.personal.phone}</a>
                </dd>
              </dl>
          ...
          <article>
            ...
            <p style={{ fontSize: '0.9rem' }}>
              Alla våra lägenheter har utmärkt kollektivtrafikförbindelser och ligger nära butiker,
              restauranger och grönområden.
            </p>
            ...
            <details>
              ...
              <ul>
                <li>
                  <strong>Söderköping centrum</strong> - Nära Göta kanal och historiska centrum
                </li>
                <li>
                  <strong>Stockholm Södermalm</strong> - Urbant boende med närhet till city
                </li>
              </ul>
            </details>
          </article>
